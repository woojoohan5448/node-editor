...
export default function Toolbar({ mode, onModeChange, onAddNode, selectedCount = 0, hasClipboard = false, onAlign, onCopy, onCut, onPaste, onDeleteSelected }) {
  return (
    <div style={container}>
      <button
      ...
      {(selectedCount >= 1 || hasClipboard) && (
        <>
          <div style={divider} />
          <button style={{ ...alignBtn, ...(selectedCount < 1 ? { opacity: 0.3, cursor: 'default' } : {}) }} onClick={selectedCount >= 1 ? onCopy : undefined} title="복사 (⌘C)">
          ...
          <button style={{ ...alignBtn, ...(selectedCount < 1 ? { opacity: 0.3, cursor: 'default' } : {}) }} onClick={selectedCount >= 1 ? onCut : undefined} title="잘라내기 (⌘X)">
          ...
          <button style={{ ...alignBtn, ...(!hasClipboard ? { opacity: 0.3, cursor: 'default' } : {}) }} onClick={hasClipboard ? onPaste : undefined} title="붙여넣기 (⌘V)">
